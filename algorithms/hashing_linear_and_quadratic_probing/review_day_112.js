/**
 * Review Day 112 for Hashing Linear and Quadratic Probing
 ...
 */
function hashing_linear_and_quadratic_probing(items) {
...
const result = hashing_linear_and_quadratic_probing(testData);
